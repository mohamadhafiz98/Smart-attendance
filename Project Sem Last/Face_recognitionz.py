...
class Face_recognition:
    def __init__(self,root):
        ...
        #tajuk
        title_lbl=Label(self.root,text="Take Attendance" ,font=("Arial",35,"bold"),bg="white",fg="Black")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        #first image
        img_top=Image.open(r"C:\Users\hafiz\THE CODE\Project redesign\clg_img\img\backg.png")
        ...
        #2 image
        img_bottom=Image.open(r"C:\Users\hafiz\THE CODE\Project redesign\clg_img\img\backg.png")
        ...
        #button
        b1_1=Button(f_lbl,text="Take Attendance", cursor="hand2",command=self.face_recog,font=("Arial",15,"bold"),bg="blue",fg="white")
        b1_1.place(x=365,y=620,width=300,height=50)

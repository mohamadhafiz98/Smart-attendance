...
#atas
       #image 1
        img1=Image.open(r"clg_img\img\biru.png")
        ...
        #image 2
        img2=Image.open(r"clg_img\img\biru.png")
       ...
       #image besar
        img4=Image.open(r"clg_img\img\biru.png")
        ...
        #tajuk
        title_lbl=Label(bg_img,text="Attendance System Using Face Recognition" ,font=("times new roman",35,"bold"),bg="white",fg="red")
        title_lbl.place(x=0,y=0,width=1530,height=45)


        #image besar
        img4=Image.open(r"C:\Users\hafiz\THE CODE\fyp code\fyp 1\clg_img\img\biru.png")
        img4=img4.resize((1530,710),Image.ANTIALIAS)
        self.photoimg4=ImageTk.PhotoImage(img4)
